        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <a href="<?php echo base_url('admin/tambahBuku') ?>">
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td data-sortable="true">
                                        <a href="<?php echo base_url() ?>admin/editBuku/<?php echo $enkrip ?>" title="edit">
...
<script type="text/javascript">
    function doDelete(id_buku) {
        swal({
                title: "Delete Data Buku?",
            ...
            .then(ok => {
                if (ok) {
                    window.location.href = '<?php echo base_url() ?>admin/hapusBuku/' + id_buku
                } else {
